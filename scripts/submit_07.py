...
srun python /fs/pool/pool-schwille-spt/P6_FCS_HOassociation/Analysis/20240609_Fits_for_figures/scripts_as_used/FCS_Spectrum_fitting/scripts/07_parallel_fitting_FCS_PCMH_spectrum.py'''
