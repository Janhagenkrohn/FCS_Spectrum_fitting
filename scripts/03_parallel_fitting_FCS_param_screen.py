...
labelling_correction_list = [True, False]
incomplete_sampling_correction_list = [True, False]

n_species_list = [1, 2, 25, 100]
spectrum_type_list = ['discrete','par_Gauss', 'par_LogNorm', 'par_Gamma', 'par_StrExp'] # 'discrete', 'reg_MEM', 'reg_CONTIN', 'par_Gauss', 'par_LogNorm', 'par_Gamma', 'par_StrExp'
spectrum_parameter_list = ['Amplitude', 'N_monomers', 'N_oligomers'] # 'Amplitude', 'N_monomers', 'N_oligomers',
oligomer_type_list = ['spherical_shell'] # 'naive', 'spherical_shell', 'sherical_dense', 'single_filament', or 'double_filament'
