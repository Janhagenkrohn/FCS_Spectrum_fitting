...
in_dir_names.extend([os.path.join(glob_dir, '3a\Exports')])
in_dir_names.extend([os.path.join(glob_dir, '3b\Exports')])
in_dir_names.extend([os.path.join(glob_dir, '3c\Exports')])
